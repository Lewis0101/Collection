 ...
 * @date : 2020/6/19
 */
public class getdrawThread extends Thread {
    ...
    public getdrawThread(String name, BankAccount bankAccount, Integer withDraw) {
        super(name);
        mBankAccount = bankAccount;
        this.withDraw = withDraw;
    }

    public getdrawThread() {
    }
...
//        mBankAccount.drawMoney(withDraw);
        mBankAccount.drawMoneys(withDraw);
    }
